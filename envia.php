...
//To address and name
$mail->addAddress("info@controlyproyectoscreativos.com");



$mail->isHTML(true);

$mail->Subject = "Cotización Control y proyectos creativos";
$mail->Body = "
              <!DOCTYPE html>
                <html>
                <head>
                <title>Control y proyectos creativos</title>
                </head>
                <body  style='border:.5px solid rgba('0,0,0,0.8');background:#fff'>
                <h1 style='text-align:center;  font-weight: bold'> Control y proyectos creativos</h1>
